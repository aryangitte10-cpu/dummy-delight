...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/25",
        destructive:
        ...
        glass:
          "bg-background/80 backdrop-blur-md border border-border/50 text-foreground shadow-sm hover:bg-background/90 hover:border-primary/30",
        glow:
          "bg-primary text-primary-foreground shadow-md hover:shadow-glow hover:-translate-y-0.5",
      },
      size: {
